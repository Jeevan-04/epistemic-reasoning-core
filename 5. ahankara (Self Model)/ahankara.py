...
Core Loop:
text → Ahankara.perceive() → proposal → Ahankara.judge() → result → Ahankara.commit()
"""
...
try:
    ...
    from buddhi import Buddhi, AnswerProof
    from graph import ChittaGraph
    from hre import HRE
    from hypothetical_proof import HypotheticalAnswerProof
    from CORE_TYPES import Answer, Verdict
    from perceptual_priors import get_perceptual_priors
    from geographic_memory import get_geographic_memory
except ImportError:
    # Fallback for different import contexts
    try:
        from ..manas import Manas
        from ..buddhi import Buddhi, AnswerProof
        from ..chitta import ChittaGraph
        from ..hre import HRE
        from ..hypothetical_proof import HypotheticalAnswerProof
        from CORE_TYPES import Answer, Verdict
    except ImportError:
        print("Warning: Could not import MARC components")
        HRE = None
        HypotheticalAnswerProof = None
        Answer = None
        Verdict = None
        
    # Always try to import new modules
    try:
        from perceptual_priors import get_perceptual_priors
        from geographic_memory import get_geographic_memory
    except ImportError:
        print("Warning: Perceptual priors or geographic memory not available")
        get_perceptual_priors = None
        get_geographic_memory = None
